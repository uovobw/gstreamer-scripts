...
gst-launch-1.0 -v rtpbin name=rtpbin \
    v4l2src ! video/x-raw,width=\(int\)320,height=\(int\)240,framerate=\(fraction\)30/1 ! tee name="t" ! videoconvert ! \
    videoscale ! videorate ! avenc_mpeg4 max-key-interval=1 max-bframes=2 ! rtpmp4vpay ! rtpbin.send_rtp_sink_0 \
    ...
    alsasrc device="default" ! audio/x-raw ! audiorate ! audioresample ! \
    ...
    t. ! xvimagesink sync=true async=true
